package com.moddakir.moddakir_flutter_n_sdk
...
import com.moddakir.moddakir_flutter_n_sdk.core.CallFlutterManager
...
import com.moddakir.moddakir_flutter_n_sdk.core.call.FlutterCallFlowManager
import com.moddakir.moddakir_flutter_n_sdk.core.listeners.CallListenersSetup
import com.example.sdksample.feature.call.domain.entity.CallType

/** ModdakirFlutterNSdk */
class ModdakirFlutterNSdk: FlutterPlugin, MethodCallHandler, ActivityAware, EventChannel.StreamHandler {
  companion object {
  ...
  override fun onAttachedToEngine(flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    ...
    methodChannel = MethodChannel(flutterPluginBinding.binaryMessenger, "moddakir_flutter_n_sdk")
    methodChannel.setMethodCallHandler(this)
    Log.d(TAG, "✅ Method channel initialized")
    
    eventChannel = EventChannel(flutterPluginBinding.binaryMessenger, "moddakir_flutter_n_sdk/events")
